    ...
    return(
        <>
            ...
            <section className="d-flex justify-content-center row col-lg-12 p-5">
                ...
                <div id="service" className="bg-white mx-3 mb-4 px-3 pt-4 text-center col-md-3 col-lg-4  rounded">
                ...
                <div id="service" className="bg-white mx-3 px-3 pt-4 text-center col-md-3 col-lg-4  rounded">
