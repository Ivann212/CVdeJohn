    ...
    return(
        <>
            ...
            <section className="d-flex justify-content-center row p-5">
                <div id="service" className="bg-white mb-4 mx-3 px-3 pt-4 text-center col-md-6 col-lg-4 rounded">
                ...
                <div id="service" className="bg-white mx-3 mb-4 px-3 pt-4 text-center col-md-6 col-lg-4  rounded">
                    <i className="fa-solid fa-file-code fa-2xl text-primary pt-5 pb-4"/>
                ...
                <div id="service" className="bg-white mx-3 px-3 pt-4 text-center col-md-6 col-lg-4  rounded">
                    <i className="fa-solid fa-magnifying-glass-dollar fa-2xl text-primary pt-5 pb-4"/>
